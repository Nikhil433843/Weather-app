...
def getweather():
    try:
        ...
        obj=TimezoneFinder()
        result=obj.timezone_at(lng=location.longitude,lat=loaction.latitude)
        ...
        #Weather
        api="https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=574674046a547d5d51e63512dd7d2d10"
...
Search_icon=PhotoImage(file="serach_icon.png")
